...
<section class="home-grid">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <p>categories</p>
         <div class="flex-box">
            <a href="category.php?category=remote sensing" class="links">Remote Sensing</a>
            <a href="category.php?category=gis" class="links">GIS</a>
            <a href="category.php?category=Arcpy" class="links">Arcpy</a>
            <a href="category.php?category=gdal" class="links">GDAL</a>
            <a href="category.php?category=database management" class="links">Database Management</a>
            <a href="category.php?category=r programing" class="links">R programing</a>
            <a href="category.php?category=python" class="links">Python</a>
            <a href="category.php?category=cartography" class="links">Cartography</a>
            <a href="category.php?category=others" class="links">Others</a>
